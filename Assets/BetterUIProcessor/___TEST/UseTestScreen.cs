...
namespace TEST
{
    public class UseTestScreen : MonoBehaviour
    {
        [EditorButton]
        public void OpenHUD()
        {
            ...
            where TModel : ScreenModel, new()
        {
            ...
            var result = await ScreensManager.Instance.CreateDirectedTransition<TScreen, TView, TModel>(model).Run().Await();
        ...
        public async Task Close()
        {
            ...
            var result = await ScreensManager.Instance.CreateCloseTransition().Run().Await();
        ...
        public async Task BackHistory()
        {
            ...
            var result = await ScreensManager.Instance
